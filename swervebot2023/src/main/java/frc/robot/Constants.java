...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double TRACK_WIDTH = Units.inchesToMeters(25.9);
...
public static Object m_robotDrive;
  ...
  public static final class ModuleConstants {
    ...
    public static final double DRIVING_MOTOR_FREE_SPEED_RPS = NeoMotorConstants.FREE_SPEED_RPM / 6000;//60
    ...
    public static final int DRIVING_MOTOR_CURRENT_LIMIT = 30; // amps
