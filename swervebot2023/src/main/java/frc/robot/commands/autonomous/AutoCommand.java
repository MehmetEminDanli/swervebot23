...
public class AutoCommand {
    ...
    static Map<String, Command> eventMap = Map.of(
        "intake", new InstantCommand(() -> System.out.println("event triggered")));
            //"print", new InstantCommand(() -> SmartDashboard.putNumber("deneme", 10)));
            //"intake", new InstantCommand(() -> new LiftSubsystem().firstLevelPosition(true)));
